...
export default function VanillaThreeCar({ 
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div className="w-full h-96 bg-gradient-to-b from-sky-100 to-white rounded-lg border shadow-sm flex items-center justify-center">
        <p className="text-gray-500">Model 3D został usunięty</p>
      </div>
