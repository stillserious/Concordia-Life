            ...
            <div className={`space-y-4 md:block ${openSections.kontakt ? 'block' : 'hidden'}`}>
              <div className="flex items-center space-x-3" data-testid="footer-phone">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/70">Infolinia 24/7</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/70">Odpowiedź w 24h</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10">
            ...
            <div className={`md:block ${openSections.godziny ? 'block' : 'hidden'}`}>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-white">Całodobowo</p>
                  <p className="text-xs text-white/70">7 dni w tygodniu</p>
                  <div className="flex items-center gap-1 mt-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-xs text-green-300">Dostępni teraz</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10">
            ...
            <div className={`md:block ${openSections.bezpieczenstwo ? 'block' : 'hidden'}`}>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-white">Dane chronione</p>
                  <p className="text-xs text-white/70">Szyfrowanie SSL/TLS</p>
                  <div className="flex items-center gap-1 mt-2">
                    <div className="w-2 h-2 bg-amber-400 rounded-full"></div>
                    <span className="text-xs text-amber-300">Certyfikat ważny</span>
                  </div>
                </div>
              </div>
            </div>
