...
import ClaimVehicleACConfirmationPage from "@/pages/claim-vehicle-ac-confirmation";
  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route path="/claim/vehicle/ac/confirmation" component={ClaimVehicleACConfirmationPage} />
